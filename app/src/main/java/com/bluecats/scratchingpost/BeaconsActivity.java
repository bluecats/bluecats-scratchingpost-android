...
public class BeaconsActivity extends Activity implements TabListener
{
	...
	protected void onCreate( Bundle savedInstanceState )
	{
		...
		mAdapterBeaconsImmediate = new BeaconsAdapter( mBeaconsImmediate );
		...
		mAdapterBeaconsNear = new BeaconsAdapter( mBeaconsNear );
		...
		mAdapterBeaconsFar = new BeaconsAdapter( mBeaconsFar );
		...
		mAdapterBeaconsUnknown = new BeaconsAdapter( mBeaconsUnknown );
